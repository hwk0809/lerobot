...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "pi05_evo":
        return PI05EvoConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, PI05EvoConfig):
        from lerobot.policies.pi05_evo.processor_pi05_evo import make_pi05_evo_pre_post_processors

        processors = make_pi05_evo_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
