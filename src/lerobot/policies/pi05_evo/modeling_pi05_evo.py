...
from lerobot.policies.pi05_evo.configuration_pi05_evo import DEFAULT_IMAGE_SIZE, PI05EvoConfig
...
class PI05EvoPytorch(nn.Module):  # see openpi `PI0Pytorch`
    """Core PI05 PyTorch model."""

    def __init__(self, config: PI05EvoConfig, rtc_processor: RTCProcessor | None = None):
        super().__init__()
        self.config = config
...
class PI05EvoPolicy(PreTrainedPolicy):
    """PI05 Policy for LeRobot."""

    config_class = PI05EvoConfig
    name = "pi05_evo"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model = PI05EvoPytorch(config, rtc_processor=self.rtc_processor)
